<?php 
   $title=array('','未交办议案','刷新');
   $schcmd='议案=PE:list(Execute),关键字=keyword';
   $coumnName='code,title,type:list(type),submit_time,supervision_company,company_name,workstate';
   $hw='';//0:5%,1:5%,2:5%,3:5%,4:10%,5:30%,6:5%,6:20%,6:5%';//每列的宽度
   $index=0;//是否显示序号 0 不显示  1 显示//html_entity_decode
   $idName='id';//关键字的属性名称//
   //cmd=内部名称：动作：图片：标题
   $cmd='交办:update::交办,详情:Execute/preview::详情';//,题目:PisaExamsData/index::题目';//操作的命令
